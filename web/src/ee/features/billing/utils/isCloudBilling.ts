 ...
 * Cloud billing requires NEXT_PUBLIC_HANZO_CLOUD_REGION to be set.
 *
...
export function isCloudBillingEnabled(): boolean {
  return Boolean(env.NEXT_PUBLIC_HANZO_CLOUD_REGION);
}

/**
 * Client-side hook to check if cloud billing features are available.
 * Uses the NEXT_PUBLIC_HANZO_CLOUD_REGION to determine availability.
 *
