...
export const env = createEnv({
  ...
  server: {
    ...
    HANZO_IAM_REDIRECT_URI: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    // S3 Batch Export
    HANZO_S3_BATCH_EXPORT_ENABLED: process.env.HANZO_S3_BATCH_EXPORT_ENABLED,
    HANZO_S3_BATCH_EXPORT_BUCKET: process.env.HANZO_S3_BATCH_EXPORT_BUCKET,
    HANZO_S3_BATCH_EXPORT_PREFIX: process.env.HANZO_S3_BATCH_EXPORT_PREFIX,
    HANZO_S3_BATCH_EXPORT_REGION: process.env.HANZO_S3_BATCH_EXPORT_REGION,
    HANZO_S3_BATCH_EXPORT_ENDPOINT: process.env.HANZO_S3_BATCH_EXPORT_ENDPOINT,
    ...
    HANZO_IAM_ORG_NAME: process.env.HANZO_IAM_ORG_NAME,
