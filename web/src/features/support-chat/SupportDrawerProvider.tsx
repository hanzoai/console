...
export function SupportDrawerProvider({ children, defaultOpen = false }: SupportDrawerProviderProps) {
  const [open, setOpen] = useState(defaultOpen);
  return <SupportDrawerContext.Provider value={{ open, setOpen }}>{children}</SupportDrawerContext.Provider>;
}
