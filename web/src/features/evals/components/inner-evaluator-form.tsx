...
const INTERNAL_ENVIRONMENTS = [
  ...
  "hanzo-prompt-experiments",
  "hanzo-evaluation",
  "sdk-experiment",
] as const;

// Default filter for new trace evaluators - excludes internal Hanzo environments
                              ...
                              return (
                                <div className="flex items-center gap-2">
                                  <VariableMappingDescription
                                    title={"Object Name"}
                                    description={
                                      "Name of the Hanzo object to retrieve the data from."
                                    }
                                    href={
                                      "https://hanzo.com/docs/evaluation/evaluation-methods/llm-as-a-judge"
                                    }
