import { type ActionType } from "@hanzo/shared";
...
export class ActionHandlerRegistry {
  private static handlers: Map<ActionType, BaseActionHandler<FieldValues>> = new Map();
  ...
  static getHandler<T extends FieldValues = FieldValues>(actionType: ActionType): BaseActionHandler<T> {
  ...
  static registerHandler<T extends FieldValues>(actionType: ActionType, handler: BaseActionHandler<T>) {
