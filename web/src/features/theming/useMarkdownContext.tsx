...
export const MarkdownContextProvider = (props: PropsWithChildren) => {
  const [isMarkdownEnabled, setIsMarkdownEnabled] = useLocalStorage("shouldRenderMarkdown", true);

  return (
    <MarkdownContext.Provider value={{ isMarkdownEnabled, setIsMarkdownEnabled }}>
      {props.children}
