...
import type { AgentNodeSummary, AgentNode } from '../types/agents';
import {
  Table,
  TableBody,
  TableCell,
...
import { ChevronDown, ChevronUp, ServerProxy, Time, Earth, Network_3 } from '@/src/features/agents/components/ui/icon-bridge';
