...
export async function register() {
  ...
  // Value is true if NEXT_PUBLIC_HANZO_RUN_NEXT_INIT is "true" or undefined
  const isInitLoadingEnabled =
    process.env.NEXT_PUBLIC_HANZO_RUN_NEXT_INIT !== undefined
      ? process.env.NEXT_PUBLIC_HANZO_RUN_NEXT_INIT === "true"
      : true;
