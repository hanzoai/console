  ...
  return (
    <Page
      headerProps={{
        ...
        help: {
          description:
            "Datasets in Hanzo Cloud are a collection of inputs (and expected outputs) of an LLM application. They are used to benchmark new releases before deployment to production. See docs to learn more.",
