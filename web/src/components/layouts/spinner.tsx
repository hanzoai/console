  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="relative mx-auto flex origin-center items-center justify-center transition-all duration-300">
          <motion.div
            initial="initial"
            animate="animate"
            variants={logoVariants}
            className="relative h-6 w-6" // Reduced from w-7 h-7 to w-6 h-6
