...
export function AnnotationQueuesOnboarding({ projectId }: { projectId: string }) {
  const valuePropositions: ValueProposition[] = [
    ...
    },
    {
      ...
      description: "Use annotation data as a baseline to evaluate your other evaluation metrics",
  ...
  return (
    <SplashScreen
      ...
      primaryAction={{
        ...
        component: <CreateOrEditAnnotationQueueButton variant="default" projectId={projectId} size="lg" />,
      }}
      secondaryAction={{
        label: "Learn More",
        href: "https://hanzo.ai/docs/scores/annotation",
      }}
      videoSrc="https://static.hanzo.ai/prod-assets/onboarding/annotation-queue-overview-v1.mp4"
    />
  );
}
