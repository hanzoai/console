...
export function PromptsOnboarding({ projectId }: { projectId: string }) {
  ...
  return (
    <SplashScreen
      ...
      description="Hanzo Cloud Prompt Management helps you centrally manage, version control, and collaboratively iterate on your prompts. Start using prompt management to improve your LLM application's performance and maintainability."
