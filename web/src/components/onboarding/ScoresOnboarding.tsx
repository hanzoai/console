...
export function ScoresOnboarding() {
  const valuePropositions: ValueProposition[] = [
    ...
    },
    {
      ...
      description:
        "HanzoCloud's scores are flexible and can be used to track any metric that's associated with an LLM application",
  ...
  return (
    <SplashScreen
      ...
      secondaryAction={{
        label: "Learn More",
        href: "https://hanzo.com/docs/evaluation/evaluation-methods/custom-scores",
      }}
