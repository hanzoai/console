...
export function TracesOnboarding({ projectId }: TracesOnboardingProps) {
  const valuePropositions: ValueProposition[] = [
    ...
    },
    {
      ...
      description:
        "HanzoCloud traces can include images, audio, and other modalities. You can fully customize them to fit your needs",
  ...
  return (
    <SplashScreen
      ...
      description="Traces allow you to track every LLM call and other relevant logic in your app/agent. Nested traces in HanzoCloud help to understand what is happening and identify the root cause of problems."
