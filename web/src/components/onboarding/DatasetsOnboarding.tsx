...
export function DatasetsOnboarding({ projectId }: { projectId: string }) {
  ...
  return (
    <SplashScreen
      ...
      description="Datasets in HanzoCloud are collections of inputs (and expected outputs) for your LLM application. You can for example use them to benchmark new releases before deployment to production."
