...
export function DatasetsOnboarding({ projectId }: { projectId: string }) {
  ...
  return (
    <SplashScreen
      ...
      description="Datasets in Hanzo Console are collections of inputs (and expected outputs) for your LLM application. You can run Experiments against these datasets to test new releases before deployment to production."
