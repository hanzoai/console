...
const ciCommand = [
  ...
  // HOSTNAME=0.0.0.0 because CI runner hostnames aren't localhost-reachable.
  // Env vars (DATABASE_URL, NEXTAUTH_SECRET, etc.) are inherited from the parent process
  // which loads them via dotenv in the test:e2e script.
