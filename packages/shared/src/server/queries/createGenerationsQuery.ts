...
import { type Observation, type EventsObservation, type ObservationCoreFields } from "../../domain";
...
export type EventsObservationPublic = Partial<EventsObservation & ObservationPriceFields> & ObservationCoreFields;
