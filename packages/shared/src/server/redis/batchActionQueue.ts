...
export class BatchActionQueue {
  private static instance: Queue<TQueueJobTypes[QueueName.BatchActionQueue]> | null = null;

  public static getInstance(): Queue<TQueueJobTypes[QueueName.BatchActionQueue]> | null {
    ...
    BatchActionQueue.instance = newRedis
      ? new Queue<TQueueJobTypes[QueueName.BatchActionQueue]>(QueueName.BatchActionQueue, {
          connection: newRedis,
