...
export class NotificationQueue {
  private static instance: Queue<TQueueJobTypes[QueueName.NotificationQueue]> | null = null;

  public static getInstance(): Queue<TQueueJobTypes[QueueName.NotificationQueue]> | null {
    ...
    NotificationQueue.instance = newRedis
      ? new Queue<TQueueJobTypes[QueueName.NotificationQueue]>(QueueName.NotificationQueue, {
          connection: newRedis,
