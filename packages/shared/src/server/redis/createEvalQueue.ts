...
export class CreateEvalQueue {
  private static instance: Queue<TQueueJobTypes[QueueName.CreateEvalQueue]> | null = null;

  public static getInstance(): Queue<TQueueJobTypes[QueueName.CreateEvalQueue]> | null {
    ...
    CreateEvalQueue.instance = newRedis
      ? new Queue<TQueueJobTypes[QueueName.CreateEvalQueue]>(QueueName.CreateEvalQueue, {
          connection: newRedis,
