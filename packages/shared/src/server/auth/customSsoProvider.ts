...
const CUSTOM_EMAIL_CLAIM = env.HANZO_CUSTOM_SSO_EMAIL_CLAIM;
const CUSTOM_NAME_CLAIM = env.HANZO_CUSTOM_SSO_NAME_CLAIM;
const CUSTOM_SUB_CLAIM = env.HANZO_CUSTOM_SSO_SUB_CLAIM;
