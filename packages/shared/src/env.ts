...
const EnvSchema = z.object({
  ...
  ENCRYPTION_KEY: z
    ...
    .optional(),
  HANZO_CACHE_PROMPT_ENABLED: z.enum(["true", "false"]).default("false"),
  HANZO_CACHE_PROMPT_TTL_SECONDS: z.coerce.number().default(60 * 60),
  ...
  ENABLE_AWS_CLOUDWATCH_METRIC_PUBLISHING: z
    .enum(["true", "false"])
    .default("false"),
  HANZO_S3_CONCURRENT_WRITES: z.coerce
    .number()
    .positive()
    .default(50),
