...
Optional: `S3_EVENT_UPLOAD_ENDPOINT`, `S3_EVENT_UPLOAD_BUCKET` (`hanzo-events`), `S3_MEDIA_UPLOAD_BUCKET` (`hanzo-media`), `HANZO_INIT_ORG_IDS`, `HANZO_INIT_USER_EMAIL`, `HANZO_INIT_PROJECT_ORG_ID`, `AGENTS_API_URL`.
