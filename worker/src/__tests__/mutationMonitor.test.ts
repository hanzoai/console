...
vi.mock("../env", () => ({
  env: {
    HANZO_MUTATION_MONITOR_ENABLED: "true",
    HANZO_MUTATION_MONITOR_CHECK_INTERVAL_MS: 1000,
    HANZO_DELETION_MUTATIONS_MAX_COUNT: 40,
    HANZO_DELETION_MUTATIONS_SAFE_COUNT: 15,
