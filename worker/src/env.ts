...
const EnvSchema = z.object({
  ...
  HANZO_S3_BATCH_EXPORT_FORCE_PATH_STYLE: z.enum(["true", "false"]).default("false"),
  ...
  HANZO_INGESTION_CLICKHOUSE_WRITE_BATCH_SIZE: z.coerce.number().positive().default(1000),
  HANZO_INGESTION_CLICKHOUSE_WRITE_INTERVAL_MS: z.coerce.number().positive().default(1000),
  HANZO_INGESTION_CLICKHOUSE_MAX_ATTEMPTS: z.coerce.number().positive().default(3),
  ...
  HANZO_SKIP_INGESTION_CLICKHOUSE_READ_MIN_PROJECT_CREATE_DATE: z.string().date().optional(),
  ...
  HANZO_S3_CORE_DATA_UPLOAD_FORCE_PATH_STYLE: z.enum(["true", "false"]).default("false"),
  ...
  HANZO_CLICKHOUSE_PROJECT_DELETION_CONCURRENCY_DURATION_MS: z.coerce.number().positive().default(600_000), // 10 minutes
  HANZO_CLICKHOUSE_TRACE_DELETION_CONCURRENCY_DURATION_MS: z.coerce.number().positive().default(120_000), // 2 minutes
  HANZO_CLICKHOUSE_DATASET_DELETION_CONCURRENCY_DURATION_MS: z.coerce.number().positive().default(120_000), // 2 minutes

  // ClickHouse mutation monitoring
  HANZO_MUTATION_MONITOR_ENABLED: z.enum(["true", "false"]).default("false"),
  HANZO_MUTATION_MONITOR_CHECK_INTERVAL_MS: z.coerce.number().positive().default(60_000), // 1 minute
  HANZO_DELETION_MUTATIONS_MAX_COUNT: z.coerce.number().positive().default(15),
  HANZO_DELETION_MUTATIONS_SAFE_COUNT: z.coerce.number().positive().default(1),

  // Batch Project Cleaner configuration
  HANZO_BATCH_PROJECT_CLEANER_ENABLED: z.enum(["true", "false"]).default("false"),
  HANZO_BATCH_PROJECT_CLEANER_INTERVAL_MS: z.coerce.number().positive().default(3_600_000), // 1hr
  HANZO_BATCH_PROJECT_CLEANER_PROJECT_LIMIT: z.coerce.number().positive().default(1000), // Max projects per batch
  HANZO_BATCH_PROJECT_CLEANER_DELETE_TIMEOUT_MS: z.coerce.number().positive().default(5_400_000), // 1.5 hours for DELETE operations
  ...
  HANZO_BATCH_DATA_RETENTION_CLEANER_DELETE_TIMEOUT_MS: z.coerce.number().positive().default(5_400_000), // 1.5 hours for DELETE operations
