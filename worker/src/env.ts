...
const EnvSchema = z.object({
  ...
  HANZO_MUTATION_MONITOR_ENABLED: z.enum(["true", "false"]).default("false"),
  HANZO_MUTATION_MONITOR_CHECK_INTERVAL_MS: z.coerce
    .number()
    .positive()
    .default(60_000), // 1 minute
  HANZO_DELETION_MUTATIONS_MAX_COUNT: z.coerce
    .number()
    .positive()
    .default(15),
  HANZO_DELETION_MUTATIONS_SAFE_COUNT: z.coerce
    .number()
    .positive()
    .default(1),
  ...
  HANZO_BATCH_PROJECT_CLEANER_ENABLED: z
    .enum(["true", "false"])
    .default("false"),
  HANZO_BATCH_PROJECT_CLEANER_INTERVAL_MS: z.coerce
    .number()
    .positive()
